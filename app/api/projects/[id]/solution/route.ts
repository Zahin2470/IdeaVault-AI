...
import { solutionSchema } from "@/lib/validations/project";
import { upsertSolution } from "@/lib/services/project.service";
...
export async function PATCH(req: Request, { params }: { params: { id: string } }) {
  ...
  const result = await upsertSolution(user.id, params.id, parsed.data);
